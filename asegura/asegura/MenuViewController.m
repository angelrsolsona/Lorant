...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSArray *titles = @[@"Inicio", @"Perfil", @"Notificaciones",@"Peticiones",@"Gastos",@"Mapa y Hoteles",@"Recibos",@"Chat"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    switch (indexPath.row) {
        case 0:
        {
            /*InicioViewController *inicioViewController = [self.storyboard instantiateViewControllerWithIdentifier:@"InicioController"];
            navigationController.viewControllers = @[inicioViewController];*/
        }break;
        case 1:
        {
            /*PerfilViewController *inicioViewController = [self.storyboard instantiateViewControllerWithIdentifier:@"PerfilController"];
            navigationController.viewControllers = @[inicioViewController];*/
        }break;
